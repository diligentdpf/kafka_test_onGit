...
public abstract class TcpServer implements Runnable {
    ...
    private static List<SocketTransceiver> clients = new ArrayList<SocketTransceiver>();
    ...
    private void startClient(final Socket socket) {
        SocketTransceiver client = new SocketTransceiver(socket) {
            ...
            @Override
            public void onReceive(InetAddress addr, String s) throws IOException {
     ...
     * @param s 字符串
     */
    public abstract void onReceive(SocketTransceiver client, String s) throws IOException;
